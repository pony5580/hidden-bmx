	...
	function loop($posts, $instance) {
		...
		if ($posts->have_posts()) {
			...
			while ($posts->have_posts()) {
				...
				$li_attr = empty($post_class) ? '' : ' class="' . $post_class . '"';
				...
				if (!empty($instance['show_rating'])) {
					$loop .= g7_post_rating('<div class="post-rating">', '</div>');
				}
				...
				if (!empty($instance['show_category'])) {
					$meta[] = '<span class="block-category">' . get_the_category_list(', ') . '</span>';
				}
				...
				if (!empty($meta)) {
					$loop .= '<div class="block-meta">' . implode(' | ', $meta) . '</div>';
				}
...
if (!function_exists('g7_widgets_init')) {
	function g7_widgets_init() {
		register_sidebar(array(
			'name'          => __('Default Sidebar 1', 'g7theme'),
			'id'            => 'sidebar1',
			'description'   => __('This is the primary sidebar, located at the left of the main content.', 'g7theme'),
		...
		register_sidebar(array(
			'name'          => __('Default Sidebar 2', 'g7theme'),
			'id'            => 'sidebar2',
			'description'   => __('This is the secondary sidebar, located at the right of the main content.', 'g7theme'),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h2 class="widgettitle"><span>',
			'after_title'   => '</span></h2>',
		...
		if (!empty($custom_sidebar)) {
			foreach ($custom_sidebar as $v) {
				...
				register_sidebar(array(
					'name'          => $v,
					'id'            => g7_sidebar_id($v),
					'description'   => __('This is a custom sidebar, can be placed at the left/right of the main content.', 'g7theme'),
					'before_widget' => '<div id="%1$s" class="widget %2$s">',
					'after_widget'  => '</div>',
					'before_title'  => '<h2 class="widgettitle"><span>',
					'after_title'   => '</span></h2>',
		...
		register_sidebar(array(
			...
			'id'            => 'footer1',
			'description'   => __('This widget area is located at the footer.', 'g7theme'),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
