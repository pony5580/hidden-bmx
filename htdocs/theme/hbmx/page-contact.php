...
<div class="block">
	...
	<header>
		<h2 class="block-title"><?php _e('Contact Form', 'g7theme'); ?></h2>
	</header>
	...
	<form method="post" id="g7-contact-form">
		...
		<p>
			<button name="contact_submit" type="submit" id="g7-contact-submit" class="btn medium"><?php _e('Send Now', 'g7theme'); ?></button>
		</p>
	</form>
	<?php endif; ?>
