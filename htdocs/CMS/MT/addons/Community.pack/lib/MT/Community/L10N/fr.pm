...
## addons/Community.pack/config.yaml
    ...
    q{Increase reader engagement - deploy features to your website that make it easier for your readers to engage with your content and your company.}
        => q{Accroître l'implication du lecteur - en ajoutant des fonctionnalités sur votre site web rendant facile pour vos lecteurs de s'impliquer sur le contenu et votre société.},
    'Create forums where users can post topics and responses to topics.' =>
        'Créer des forums où les utilisateurs peuvent publier des sujets et des réponses aux sujets.',
    ...
    'New Password Reset Form' =>
        'Nouveau formulaire de réinitialisation du mot de passe',
    ...
    'A collection of styles compatible with Community themes.' =>
        'Une collection de styles compatibles avec les thèmes communauté',
    ...
    'Displays error, pending or confirmation message when submitting an entry.'
        => 'Afficher les erreurs et les messages de confirmation quand une note est écrite.',
    ...
    'Displays error, pending or confirmation message when submitting a entry.'
        => 'Affiche les messages d\'erreur, de validation et de confirmation quand une nouvelle note est créée.',
...
## addons/Community.pack/lib/MT/App/Community.pm
    'No login form template defined' =>
        'Aucun formulaire d\'identification de défini',
    'Before you can sign in, you must authenticate your email address. <a href="[_1]">Click here</a> to resend the verification email.'
        => 'Avant de pouvoir vous identifier, vous devez confirmer votre adresse email. <a href="[_1]">Cliquez ici</a> pour envoyer à nouveau l\'email de vérification.',
    'You are trying to redirect to external resources: [_1]' =>
        'Vous tentez une redirection vers des ressources externes: [_1]',
    'Successfully authenticated but signing up is not allowed.  Please contact system administrator.'
        => 'Identification réussie mais l\'enregistrement n\'est pas autorisé. Merci de contacter l\'administrateur système.',
    '(No email address)' => '(pas d\'adresse e-mail)',
    'User \'[_1]\' (ID:[_2]) has been successfully registered.' =>
        'L\'utilisateur \'[_1]\' (ID:[_2]) a été enregistré avec succès.',
    'Thanks for the confirmation.  Please sign in.' =>
        'Merci pour la confirmation. Identifiez-vous.',
    '[_1] registered to Movable Type.' =>
        '[_1] s\'est enregistré(e) à Movable Type.',
    ...
    'System template entry_response not found in blog: [_1]' =>
        'Gabarit système entry_response introuvable dans le blog: [_1]',
    'New entry \'[_1]\' added to the blog \'[_2]\'' =>
        'Nouvelle note \'[_1]\' ajoutée sur le blog \'[_2]\'',
    'Id or Username is required' => 'Id ou identifiant obligatoire',
    'Unknown user'               => 'Utilisateur inconnu',
    'All required fields must have valid values.' =>
        'Tous les champs obligatoires doivent avoir des valeurs valides.',
...
## addons/Community.pack/lib/MT/Community/CMS.pm
    'Movable Type was unable to write on the "Upload Destination". Please make sure that the folder is writable from the web server.'
        => 'Movable Type n\'a pas réussi à écrire dans la destination du téléchargement. Veuillez vérifier que le répertoire de destination est ouvert en écriture au niveau du serveur web.',
...
## addons/Community.pack/lib/MT/Community/Tags.pm
    'You used an \'[_1]\' tag outside of the block of MTIfEntryRecommended; perhaps you mistakenly placed it outside of an \'MTIfEntryRecommended\' container?'
        => 'Vous avez utilisé un tag \'[_1]\' en dehors d\'un bloc de MTIfEntryRecommended; Peut-être l\'avez-vous placé par erreur en dehors d\'un conteneur \'MTIfEntryRecommended\' ?',
...
## addons/Community.pack/templates/blog/about_this_page.mtml
    'This page contains a single entry by <a href="[_1]">[_2]</a> published on <em>[_3]</em>.'
        => 'Cette page contient une unique note de <a href="[_1]">[_2]</a> publiée le <em>[_3]</em>.',
...
## addons/Community.pack/templates/blog/comments.mtml
    'The data in #comments-content will be replaced by some calls to paginate script'
        => 'Les données dans #comments-content seront remplacées par des appels aux scripts de pagination.',
...
## addons/Community.pack/templates/blog/entry_form.mtml
    'In order to create an entry on this blog you must first register.' =>
        'Avant de créer une note sur ce blog, vous devez vous enregistrer.',
    q{You don't have permission to post.} =>
        q{Vous n'avez pas la permission de poster.},
...
## addons/Community.pack/templates/blog/entry_response.mtml
    q{Thank you for posting an entry.} =>
        q{Merci d'avoir posté votre message.},
    'Entry Pending' => 'Message en attente',
    q{Your entry has been received and held for approval by the blog owner.}
        => q{Votre message a été reçu et est en attente d'approbation par le propriétaire du blog.},
    ...
    q{Return to the <a href="[_1]">blog's main index</a>.} =>
        q{Retour à la <a href="[_1]">page principale du blog</a>.},
...
## addons/Community.pack/templates/forum/comment_response.mtml
    ...
    q{Your reply has been received and held for approval by the forum administrator.}
        => q{Votre réponse a bien été reçue et est en attente d'approbation par un administrateur du forum.},
    q{Reply Submission Error} => q{Erreur lors de l'envoi de la réponse},
    q{Your reply submission failed for the following reasons: [_1]} =>
        q{L'envoi de la réponse a échoué pour les raisons suivantes : [_1]},
    q{Return to the <a href="[_1]">original topic</a>.} =>
        q{Retour au <a href="[_1]">sujet d'origine</a>.},
...
## addons/Community.pack/templates/forum/entry_response.mtml
    q{Thank you for posting a new topic to the forums.} =>
        q{Merci d'avoir créé un nouveau sujet dans le forum.},
    'Topic Pending' => 'Sujet en attente',
    'The topic you posted has been received and held for approval by the forum administrators.'
        => 'Le sujet que vous avez créé a bien été reçu et il est en attente de validation par les administrateurs du forum.',
    'Topic Posted' => 'Sujet posté',
    'The topic you posted has been received and published. Thank you for your submission.'
        => 'Le sujet que vous avez créé a bien été reçu et publié. Merci.',
    q{Return to the <a href="[_1]">forum's homepage</a>.} =>
        q{Retour à la <a href="[_1]">page d'accueil du forum</a>.},
...
## addons/Community.pack/templates/forum/entry_table.mtml
    ...
    'Post the first topic in this forum.' =>
        'Créez le premier sujet de ce forum.',
...
## addons/Community.pack/templates/forum/javascript.mtml
    ...
    '. Now you can reply to this topic.' =>
        '. Maintenant vous pouvez répondre à ce sujet.',
    q{You do not have permission to comment on this blog.} =>
        q{Vous n'avez pas la permission de commenter sur ce blog.},
...
## addons/Community.pack/templates/forum/search_results.mtml
    'Topics matching &ldquo;[_1]&rdquo;' =>
        'Sujets correspondants à &ldquo;[_1]&rdquo;',
    'Topics tagged &ldquo;[_1]&rdquo;' =>
        'Sujets taggués &ldquo;[_1]&rdquo;',
    'Topics' => 'Sujets',
...
## addons/Community.pack/templates/global/email_verification_email.mtml
    'Thank you registering for an account to [_1].' =>
        'Merci de créer un compte sur [_1].',
    'For your own security and to prevent fraud, we ask that you please confirm your account and email address before continuing. Once confirmed you will immediately be allowed to sign in to [_1].'
        => 'Pour votre propre sécurité et pour prévenir la fraude, nous vous demandons de confirmer votre compte et adresse email avant de continuer. Une fois confirmés vous serez immédiatement autorisé à vous identifier sur [_1].',
    q{To confirm your account, please click on or cut and paste the following URL into a web browser:}
        => q{Pour confirmer votre compte, cliquez ou copiez-collez l'adresse suivante dans un navigateur web :},
    q{If you did not make this request, or you don't want to register for an account to [_1], then no further action is required.}
        => q{Si vous n'avez pas fait cette demande, ou que vous ne souhaitez pas créer un compte sur [_1], alors aucune action n'est nécessaire.},
...
## addons/Community.pack/templates/global/new_entry_email.mtml
    q{A new entry '[_1]([_2])' has been posted on your blog [_3].} =>
        q{Une nouvelle note '[_1]([_2])' a été postée sur votre blog [_3].},
...
## addons/Community.pack/templates/global/profile_edit_form.mtml
    'Go <a href="[_1]">back to the previous page</a> or <a href="[_2]">view your profile</a>.'
        => 'Retourner à  <a href="[_1]">la page précédente</a> ou <a href="[_2]">voir votre profil</a>.',
...
## addons/Community.pack/templates/global/profile_feed.mtml
    ...
    '[_1] voted on <a href="[_2]">[_3]</a> in [_4]' =>
        '[_1] a voté sur <a href="[_2]">[_3]</a> dans [_4]',
...
## addons/Community.pack/templates/global/register_notification_email.mtml
    q{This email is to notify you that a new user has successfully registered on the blog '[_1]'. Listed below you will find some useful information about this new user.}
        => q{Un nouvel utilisateur s'est enregistré sur le blog '[_1]'. Vous trouverez ci-dessous quelques informations utiles à propos de ce nouvel utilisateur.},
...
## addons/Community.pack/templates/global/signin.mtml
    'You are signed in as <a href="[_1]">[_2]</a>' =>
        'Vous êtes identifié(e) comme étant <a href="[_1]">[_2]</a>',
    'You are signed in as [_1]' =>
        'Vous êtes identifié(e) comme étant [_1]',
...
## addons/Community.pack/tmpl/cfg_community_prefs.tmpl
    ...
    q{Check to allow anonymous users (users not logged in) to recommend discussion.  IP address is recorded and used to identify each user.}
        => q{Cocher pour autoriser les utilisateurs anonymes (non identifiés) à recommander une discussion. L'adresse IP est enregistrée et utilisée pour identifier chaque utilisateur.},
    'Allow anonymous user to recommend' =>
        'Autoriser un utilisateur anonyme à recommander',
    'Junk Filter' => 'Filtre de spam',
    'If enabled, all moderated entries will be filtered by Junk Filter.' =>
        'Si activé, toutes les notes modérées seront filtrés par le filtre de spam',
...
## addons/Community.pack/tmpl/widget/blog_stats_registration.mtml
    ...
    'You have [quant,_1,registration,registrations] from [_2]' =>
        'Vous avez [quant,_1,création de compte,créations de compte] sur [_2]',
...
## addons/Community.pack/tmpl/widget/recently_scored.mtml
    q{There are no recently favorited entries.} =>
        q{Il n'y a pas de notes favorites récentes.},
